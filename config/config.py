...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/Luciferrj29/Extra-Plugin",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7394590844").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Luciferrj29/VIP-MUSIC",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/STD_DEEPANSHU"
)  # Example:- https://t.me/STD_DEEPANSHU
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/STD_QUIZ"
